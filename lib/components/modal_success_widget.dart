                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            '9gy54ncf' /* Send Contract Confirmation */,
                          ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'eu3x7kox' /* A new contract has been genera... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'lhl0euva' /* Send the information below. An... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
