                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'fu8dlidh' /* Below is a summary of your tea... */,
                                      ),
                    ...
                    Container(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final listViewAllVehiclesResponse = snapshot.data!;
                          return Builder(
                            builder: (context) {
                              final allVehicles =
                                  listViewAllVehiclesResponse.jsonBody.toList();
                              return ListView.builder(
                                padding: EdgeInsets.zero,
                                shrinkWrap: true,
                                scrollDirection: Axis.horizontal,
                                itemCount: allVehicles.length,
                                itemBuilder: (context, allVehiclesIndex) {
                                  final allVehiclesItem =
                                      allVehicles[allVehiclesIndex];
                                  return Stack(
                                    children: [
                                      Container(
                                        width: 175.0,
