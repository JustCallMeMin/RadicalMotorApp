...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    radicalMotorAuthUserSubject.add(
      RadicalMotorAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<RadicalMotorAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  RadicalMotorAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = RadicalMotorAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    radicalMotorAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
RadicalMotorAuthUser? currentUser;
