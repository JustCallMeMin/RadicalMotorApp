                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'nclq855m' /* No-Code Platform Design */,
                                                        ),
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '15ttk4ny' /* Contracts for New Opportunitie... */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodySmall
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '0lf4wvmw' /* Client Acquisition for Q3 */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodySmall
